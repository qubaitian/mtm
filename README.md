...
MTM reads valid Completion entries.
The Completion menu opens automatically while typing a prefix.
Type a code, then press `1` to accept a candidate.
